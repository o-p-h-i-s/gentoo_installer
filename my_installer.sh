...
cat << EOT > /usr/src/linux/.config
#
# Automatically generated file; DO NOT EDIT.
# Linux/x86 5.16.11-gentoo Kernel Configuration
#
CONFIG_CC_VERSION_TEXT="x86_64-pc-linux-gnu-gcc (Gentoo 11.2.1_p20220115 p4) 11.2.1 20220115"
CONFIG_CC_IS_GCC=y
...
# end of Gentoo Linux
EOT
genkernel all --microcode --oldconfig
cat << EOT >> /etc/fstab
...
127.0.0.1	localhost
::1		localhost
127.0.0.1	sophia.localdomain	sophia
...
cat << EOT > /etc/systemd/network/50-dhcp.network
[Match]
Name=en*
